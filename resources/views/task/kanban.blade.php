                            ...
                            <div class="md:flex items-center justify-between flex-wrap gap-4">
                                <div class="grid grid-cols-12 gap-2 md:w-[30%]">
                                    <div class="xl:col-span-5 col-span-12">
                                        <a href="javascript:void(0);" class="hs-dropdown-toggle  ti-btn bg-primary text-white !font-medium " data-hs-overlay="#add-board"><i class="ri-add-line !text-[1rem]"></i>New Board
                                        </a>
                                    </div>
                            ...
                            <div class="box kanban-tasks todo">
                                <div class="box-body !p-0">
                                    <div class="p-4 kanban-board-head">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="task-badges"><span class="badge bg-light text-default">#SPK - 07</span><span class="ms-1 badge bg-pink/10">Admin</span><span class="ms-1 badge bg-light text-default">Authentication</span></div>
                                            <div class="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                                                <a aria-label="anchor" href="javascript:void(0);" class="ti-btn ti-btn-icon ti-btn-sm ti-btn-light" aria-expanded="false">
                                                    <i class="fe fe-more-vertical"></i>
                                                </a>
                            ...
                            <div class="box kanban-tasks interview">
                                <div class="box-body !p-0">
                                    <div class="p-4 kanban-board-head">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="task-badges"><span class="badge bg-light text-default">#SPK - 15</span><span class="ms-1 badge bg-purple/10 text-purple">Review</span></div>
                                            <div class="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                                                <a aria-label="anchor" href="javascript:void(0);" class="ti-btn ti-btn-icon ti-btn-sm ti-btn-light" aria-expanded="false">
                                                    <i class="fe fe-more-vertical"></i>
                                                </a>
                            ...
                            <div class="box kanban-tasks completed">
                                <div class="box-body !p-0">
                                    <div class="p-4 kanban-board-head">
                                        ...
                                        <div class="kanban-content mt-2">
                                            <div class="task-image mt-2">
                                                <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/media/media-86.svg" class="img-fluid rounded kanban-image bg-light" alt="">
                                            </div>
