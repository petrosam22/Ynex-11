                        ...
                        <div class="box-header justify-between">
                            ...
                            <div class="flex">
                                <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#create-task">
                                    <i class="ri-add-line font-semibold align-middle"></i> Create Lesson
                                  </button>
                                    ...
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                      <div class="ti-modal-content">
                                        <div class="ti-modal-header">
                                            <h6 class="modal-title" id="staticBackdropLabel2">Add Lesson
                                            </h6>
                                        ...
                                        <div class="ti-modal-body">
                                            <div class="grid grid-cols-12 gap-2">
                                                <div class="xl:col-span-6 col-span-12">
                                                    <label for="task-name" class="form-label">Lesson Name</label>
                                                    <input type="text" class="form-control" id="task-name" placeholder="Lesson Name">
                                                </div>
                                                <div class="xl:col-span-6 col-span-12">
                                                    <label for="task-id" class="form-label">Course</label>
                                                    <input type="text" class="form-control" id="task-id" placeholder="Course ID">
                                                </div>
                                                <div class="xl:col-span-6 col-span-12">
                                ...
                                <div class="hs-dropdown ti-dropdown ms-2">
                                    ...
                                    <ul class="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="javascript:void(0);">New Leesons</a></li>
                                        <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="javascript:void(0);">Pending Leesons</a></li>
                                        <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="javascript:void(0);">Completed Leesons</a></li>
                                        <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block" href="javascript:void(0);">Inprogress Leesons</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table whitespace-nowrap table-bordered min-w-full">
                                    ...
                                    <tbody>
                                        <tr class="border border-defaultborder task-list">
                                            ...
                                            <td>
                                                <span class="font-semibold">Write Your First PHP Code: Display a Message in Your Web Browser	
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <button type="button" class="hs-tooltip-toggle ti-btn ti-btn-danger ms-1 ti-btn-sm task-delete-btn">
                    ...
                    <div class="box">
                        <div class="box-body !p-0">
                            <div class="!p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start">
                                ...
                                <div class="flex-grow">
                                    <h6 class="!mb-1 text-[0.75rem]">New  
                            ...
                            <div class="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start">
                                ...
                                <div class="flex-grow">
                                    <h6 class="mb-1 text-[0.75rem]">Completed  
                            ...
                            <div class="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start">
                                ...
                                <div class="flex-grow">
                                    <h6 class="mb-1 text-[0.75rem]">Pending  
                            ...
                            <div class="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start">
                                ...
                                <div class="flex-grow">
                                    <h6 class="mb-1 text-[0.75rem]">Inprogress  
                            ...
                            <div class="p-6 pb-2">
                                <p class="text-[.9375rem] font-semibold">Lessons Statistics <span class="text-muted font-normal">(Last 6 months) :</span></p>
