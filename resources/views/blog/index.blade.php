                                      ...
                                      <div class="swiper mySwiper8">
                                          <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                              <div class="rtl:dir-rtl">
                                                  <a href="javascript:void(0);">
                                                      <img src="../assets/images/media/media-70.jpg" class="block-full" alt="...">
                                                      <div class="blog-caption text-start">
                                                          ...
                                                          <div class="flex items-center">
                                                              <img src="../assets/images/faces/15.jpg" alt="" class="shadow-none ring-transparent avatar avatar-sm !rounded-full me-2">
                                            ...
                                            <div class="swiper-slide">
                                              <div class="rtl:dir-rtl">
                                                  <a href="javascript:void(0);">
                                                      <img src="../assets/images/media/media-71.jpg" class="block-full" alt="...">
                                                      <div class="blog-caption text-start">
                                            ...
                                            <div class="swiper-slide">
                                              <div class="rtl:dir-rtl">
                                                  <a href="javascript:void(0);">
                                                      <img src="../assets/images/media/media-72.jpg" class="block-full" alt="...">
                                                      <div class="blog-caption text-start">
                                                          ...
                                                          <div class="flex items-center">
                                                              <img src="../assets/images/faces/4.jpg" alt="" class="shadow-none ring-transparent avatar avatar-sm !rounded-full me-2">
                          ...
                          <div class="xxl:col-span-6 xl:col-span-12 col-span-12">
                                <div class="grid grid-cols-12 gap-x-6">
                                  <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                      <div class="box">
                                          <a href="javascript:void(0);">
                                              <img src="../assets/images/media/media-36.jpg" class="card-img-top rounded-t-sm" alt="...">
                                          </a>
                                          <div class="box-body">
                                              <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1">Touring excites in winter !</a>
                                  ...
                                  <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                      <div class="box">
                                          <a href="javascript:void(0);">
                                              <img src="../assets/images/media/media-35.jpg" class="card-img-top rounded-t-sm" alt="...">
                                          </a>
                                          <div class="box-body">
                                              <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1"> Boat manufacutrers are in debt !</a>
                                  ...
                                  <div class="xl:col-span-6 xxl:col-span-8 col-span-12">
                                        <div class="grid grid-cols-12 gap-x-6">
                                          <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                              <div class="box">
                                                  <a href="javascript:void(0);">
                                                      <img src="../assets/images/media/media-26.jpg" class="card-img-top rounded-t-sm" alt="...">
                                                  </a>
                                                  <div class="box-body">
                                                      <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1">Features of new car !</a>
                                                      <p class="card-text text-[#8c9097] dark:text-white/50 mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                      <a href="javascript:void(0);" class="ti-btn ti-btn-primary !font-medium !mb-0">Read More</a>
                                                  </div>
                                                  <div class="box-footer">
                                          ...
                                          <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                              <div class="box">
                                                  <a href="javascript:void(0);">
                                                      <img src="../assets/images/media/media-31.jpg" class="card-img-top rounded-t-sm" alt="...">
                                                  </a>
                                                  <div class="box-body">
                                                      <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1">Beautiful beach on a sunny day !</a>
                                                      <p class="card-text text-[#8c9097] dark:text-white/50 mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                      <a href="javascript:void(0);" class="ti-btn ti-btn-primary !font-medium !mb-0">Read More</a>
                                                  </div>
                                                  <div class="box-footer">
                          ...
                          <div class="xl:col-span-12 col-span-12">
                                <div class="grid grid-cols-12 gap-x-6">
                                  <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                      <div class="box">
                                          <a href="javascript:void(0);">
                                              <img src="../assets/images/media/media-40.jpg" class="card-img-top rounded-t-sm" alt="...">
                                          </a>
                                          <div class="box-body">
                                              <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1">Strawberry juice recipe.</a>
                                  ...
                                  <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                      <div class="box">
                                          <a href="javascript:void(0);">
                                              <img src="../assets/images/media/media-61.jpg" class="card-img-top rounded-t-sm" alt="...">
                                          </a>
                                          <div class="box-body">
                                              <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1">Night Sky is pleasent to watch.</a>
                                  ...
                                  <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                      <div class="box">
                                          <a href="javascript:void(0);">
                                              <img src="../assets/images/media/media-42.jpg" class="card-img-top rounded-t-sm" alt="...">
                                          </a>
                                          <div class="box-body">
                                              <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1">Is fashion industry growing ?</a>
                                  ...
                                  <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                      <div class="box">
                                          <a href="javascript:void(0);">
                                              <img src="../assets/images/media/media-59.jpg" class="card-img-top rounded-t-sm" alt="...">
                                          </a>
                                          <div class="box-body">
                                              <a href="blog-details.html" class="font-semibold text-[0.875rem] text-dark mb-1">Raising sun is a blessing to watch ..</a>
