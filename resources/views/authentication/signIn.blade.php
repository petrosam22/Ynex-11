                  ...
                  <form method="post" action="{{ route('user.Login') }}">
                    ...
                    <div class="grid grid-cols-12 gap-y-4">
                        <div class="xl:col-span-12 col-span-12 mt-0">
                            ...
                            <input type="text" class="form-control form-control-lg w-full !rounded-md" id="signin-username" name="email" placeholder="Email">
                        ...
                        <div class="xl:col-span-12 col-span-12 grid mt-2">
                            {{--  <a href="index.html" class="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Sign In</a>  --}}

                            <button type="submit" class="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Sign In</button>
                    ...
                    <div class="text-center">
                        <p class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Dont have an account?
                            <a href="{{ route('user.registerForm') }}" class="text-primary">Sign Up</a></p>
                    </div>
                </div>
            </div>
            <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
