                ...
                <div class="box custom-box">
                    ...
                    <div class="box-body">
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="date" class="form-control" id="weeknum"
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="from" class="form-control" id="timepikcr" placeholder="Choose time">
                            </div>
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-text text-[#8c9097] dark:text-white/50 !border-e-0"> <i class="ri-time-line"></i> </div>
                                        <input type="text" name="to" class="form-control" id="timepikcr" placeholder="Choose time">
                            ...
                            placeholder="Enter Event Name">
                            <input type="hidden" name="status_id"  value="{{ $status->id }}" class="form-control" id="input-label"
                            placeholder="Enter Event Name">
