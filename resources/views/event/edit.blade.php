                    ...
                    <div class="box-body">
                        <div class="grid grid-cols-12 gap-4">
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <input type="text" name="name" value="{{ $event->name }}" class="form-control" id="input-label"
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="date" value="{{ $event->date }}" class="form-control" id="weeknum"
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="from" value="{{ $event->from }}" class="form-control" id="timepikcr" placeholder="Choose time">
                            </div>
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-text text-[#8c9097] dark:text-white/50 !border-e-0"> <i class="ri-time-line"></i> </div>
                                        <input type="text" name="to" value="{{ $event->to}}" class="form-control" id="timepikcr" placeholder="Choose time">
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="description" value="{{ $event->description }}" class="form-control" id="input-label"
                                            placeholder="Enter Event Name">
                            ...
                            <input type="hidden" name="user_id"  value="{{ Auth::user()->id }}" class="form-control" id="input-label"
                            placeholder="Enter Event Name">
