            ...
            <div class="content">
                <div class="main-content">
                        ...
                        <div class="block justify-between page-header md:flex">
                            <div>
                                <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Transfer
</h3>
                            </div>
                                ...
                                <div class="box">
                                    <div class="box-header justify-between">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <div>
                                                <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-secondary-full !py-1 !px-2 !text-[0.75rem] btn-wave" data-hs-overlay="#create-task">Create Transfer</button>
                                            </div>
                                        </div>
                                                ...
                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                                  <div class="ti-modal-content">
                                                    <div class="ti-modal-header">
                                                        <h6 class="modal-title" id="staticBackdropLabel2">Add Transfer
                                                    ...
                                                    <div class="ti-modal-body">
                                                        <div class="grid grid-cols-12 gap-2">
                                                            <div class="xl:col-span-6 col-span-12">
                                                                <label for="task-name" class="form-label">Goal	</label>
                                                                <input type="text" class="form-control" id="task-name" placeholder="Goal	">
                                                            </div>
                                                            <div class="xl:col-span-6 col-span-12">
                                                            ...
                                                            <div class="xl:col-span-6 col-span-12">
                                                                <label for="task-id" class="form-label">Wallet	</label>
                                                                <input type="text" class="form-control" id="task-id" placeholder="Wallet	">
                                                            </div>
                                                            <div class="xl:col-span-6 col-span-12">
                                                                <label for="task-id" class="form-label">Amount	</label>
                                                                <input type="text" class="form-control" id="task-id" placeholder="Amount	">
                                                            </div>
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <table class="table whitespace-nowrap table-bordered min-w-full">
                                                ...
                                                <tr>
                                                        <th scope="col"></th>
                                                        <th scope="col" class="text-start">Goal</th>
                                                ...
                                                <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                ...
                                                                <div class="font-semibold">1200</div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <span>Salary</span>
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-body !p-0">
                                            <div class="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">New Transfer
                                            ...
                                            <div class="p-4 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">Total Transfer 
