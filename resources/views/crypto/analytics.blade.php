                ...
                <div class="main-content">
                                ...
                                <div class="box-body">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-6 pe-0">
                                            <p class="mb-2">
                                                <span class="text-[1rem]">InCome</span>
                                            </p>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-6 pe-0">
                                            <p class="mb-2">
                                                <span class="text-[1rem]">Expenses</span>
                                            </p>
                                            <p class="mb-2 text-[0.75rem]">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-6 pe-0">
                                            <p class="mb-2">
                                                <span class="text-[1rem]">Wallet</span>
                                            </p>
                                            <p class="mb-2 text-[0.75rem]">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-6 pe-0">
                                            <p class="mb-2">
                                                <span class="text-[1rem]">Transactions</span>
                                            </p>
                                            <p class="mb-2 text-[0.75rem]">
                                                <span class="text-[1.5625rem] font-semibold leading-none vertical-bottom mb-0">63</span>
                                                <span class="block text-[0.625rem] font-semibold text-[#8c9097] dark:text-white/50">THIS MONTH</span>
                                            </p>
                                            <a href="javascript:void(0);" class="text-[0.75rem] mb-0 text-primary">Show full stats<i class="ti ti-chevron-right ms-1"></i></a>
                                        </div>
                    ...
                    <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="lg:col-span-6 sm:col-span-12 md:col-span-6 xxl:col-span-3 xl:col-span-4 col-span-12">
                            <div class="box">
                                <div class="box-header justify-between">
                                    <div class="box-title">Transfer</div>
                                    <div class="hs-dropdown ti-dropdown">
                                ...
                                <div class="box-body mt-0 latest-timeline max-h-96" id="latest-timeline">
                                    <ul class="timeline-main mb-0 list-unstyled">
                                        ...
                                        <li class="mt-0 activity">
                                            <a href="javascript:void(0);" class="text-[0.75rem]">
                                                <p class="mb-0"><span class="me-2 text-[0.75rem]">New Transfer Added.</span><span class="font-semibold">#FX-321</span> </p>
                                            </a>
                        ...
                        <div class="xxl:col-span-6 xl:col-span-12 md:col-span-12 col-span-12">
                            <div class="box">
                                <div class="box-header sm:flex block">
                                    <div class="box-title">Recent Transactions
</div>
                                    ...
                                    <div class="sm:mt-0 mt-2">
                                        <button type="button" class="btn btn-sm btn-light"><i class="ti ti-plus me-1 font-semibold align-middle inline-block"></i>Add Transaction</button>
                                    </div>
                                </div>
                                                ...
                                                <table class="table whitespace-nowrap table-hover min-w-full">
                                                    ...
                                                    <tbody>
                                                        <tr class="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                            ...
                                                            <td>  Json Taylor</td>
                                                            <td class="text-[#8c9097] dark:text-white/50">EGP</td>
                                                            <td><span class="badge bg-primary text-white">24,Jul 2023 - 4:23PM	</span></td>
                                                            <td>
                                                                 120.00
                                                            </td>

                                                            <td><span class="badge bg-primary text-white">Pending	</span></td>
                                                            <td>
                                                            <span class="badge bg-danger/10 text-danger">Credit</span>
                                                            </td>
                                                        ...
                                                        <tr class="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                            ...
                                                            <td><span class="badge bg-primary text-white">Pending	</span></td>
                                                            <td>
                                                            <span class="badge bg-success/10 text-success">Debit</span>
                                                        </td>
                            ...
                            <div class="box overflow-hidden">
                                ...
                                <div class="box-body !p-0">
                                    <div class="grid grid-cols-12 gap-x-4">
                                        <div class="xxl:col-span-12 xl:col-span-12  col-span-12 sales-visitors-countries">
                                            <div class="mt-2">
                                                <ul class="list-none p-6 my-auto">
                                                    <li class="mb-4">
                                                        <span class="text-[0.75rem]">
                                                            <i class="ri-checkbox-blank-circle-fill align-middle me-2 inline-block text-primary">

                                                            </i>Labtop</span><span class="font-semibold ltr:float-right rtl:float-left">3,201</span>
                                                    </li>
                                                    <li class="mb-4">
                                                        <span class="text-[0.75rem]">
                                                            <i class="ri-checkbox-blank-circle-fill align-middle me-2 inline-block text-secondary"></i>
                                                            Phone</span><span class="font-semibold ltr:float-right rtl:float-left">2,345</span>
                                                    </li>
                                                    <li class="mb-4">
                                                        <span class="text-[0.75rem]"><i class="ri-checkbox-blank-circle-fill align-middle me-2 inline-block text-danger"></i>Vaction</span><span class="font-semibold ltr:float-right rtl:float-left">106</span>
                                                    </li>
                                                    <li class="mb-4">
                                                        <span class="text-[0.75rem]"><i class="ri-checkbox-blank-circle-fill align-middle me-2 inline-block text-info"></i>Clothes</span><span class="font-semibold ltr:float-right rtl:float-left">2,857</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="box-body !p-0 customers">
                                    <ul class="list-group my-1">
                                        <li class="list-group-item !py-3 !border-0">
                                            <a href="javascript:void(0);" class="!border-0">
                                                <div class="flex items-start">
                                                    <img class="avatar avatar-md me-4 my-auto" src="../assets/images/faces/2.jpg" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item !py-3 !border-0">
                                            <a href="javascript:void(0);" class="!border-0">
                                                <div class="flex items-start">
                                                    <img class="avatar avatar-md me-4 my-auto" src="../assets/images/faces/1.jpg" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item !py-3 !border-0">
                                            <a href="javascript:void(0);" class="!border-0">
                                                <div class="flex items-start">
                                                    <img class="avatar avatar-md me-4 my-auto" src="../assets/images/faces/5.jpg" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item !py-3 !border-0">
                                            <a href="javascript:void(0);" class="!border-0">
                                                <div class="flex items-start">
                                                    <img class="avatar avatar-md me-4 my-auto" src="../assets/images/faces/7.jpg" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item !py-3 !border-0">
                                            <a href="javascript:void(0);" class="!border-0">
                                                <div class="flex items-start">
                                                    <img class="avatar avatar-md me-4 my-auto" src="../assets/images/faces/9.jpg" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item !py-3 !border-0">
                                            <a href="javascript:void(0);" class="!border-0">
                                                <div class="flex items-start">
                                                    <img class="avatar avatar-md me-4 my-auto" src="../assets/images/faces/11.jpg" alt="Image description">
                                                    <div class="mt-0">
                                                        <p class="mb-1 font-semibold">Manuel Labor</p>
                            ...
                            <div class="box">
                                <div class="box-header justify-between">
                                    ...
                                    <div class="hs-dropdown ti-dropdown">
                                        ...
                                        <ul class="hs-dropdown-menu ti-dropdown-menu hidden">
                                            <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                    href="{{route('create.wallet')}} ">Create Wallet</a></li>
                                            <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                    href="javascript:void(0);">Another action</a></li>
                                            <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                                    href="javascript:void(0);">Something else here</a></li>
                                ...
                                <div class="box-body !p-0 px-1">
                                    <div id="sale-value" class="p-5">



                                    </div>
                                    <div class="grid grid-cols-12 pt-3 ">
                                        <div class="xl:col-span-12  col-span-12 border-b dark:border-defaultborder/10 pb-5 text-center flex flex-wrap justify-center"><span class="font-semibold ms-2 text-primary px-4">60% Increase in Salary value since last week</span></div>
                                        ...
                                        <div class="xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-6  p-4 text-center">
                                            <p class="mb-1">Expences</p>
                                            <h5 class="mb-1 font-semibold">$11,197</h5>
                                            <p class="text-[0.6875rem] text-[#8c9097] dark:text-white/50 mb-0">Profit<span class="text-danger ms-2">
                                                <i class="ri-arrow-down-s-line me-2 font-bold align-middle inline-block"></i>
                                                <span class="badge bg-success/10 text-success !text-[0.6875rem]">0.15%</span></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
