            ...
            <div class="content">
                <div class="main-content">
                        ...
                        <div class="block justify-between page-header md:flex">
                            <div>
                                <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Goals
</h3>
                            </div>
                                ...
                                <div class="box">
                                    <div class="box-header justify-between">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <div>
                                                <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-secondary-full !py-1 !px-2 !text-[0.75rem] btn-wave" data-hs-overlay="#create-task">Create Goals</button>
                                            </div>
                                        </div>
                                                ...
                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                                  <div class="ti-modal-content">
                                                    <div class="ti-modal-header">
                                                        <h6 class="modal-title" id="staticBackdropLabel2">Add Goals
                                                    ...
                                                    <div class="ti-modal-body">
                                                        <div class="grid grid-cols-12 gap-2">
                                                            ...
                                                            <div class="xl:col-span-6 col-span-12">
                                                                <label for="task-id" class="form-label">Price</label>
                                                                <input type="text" class="form-control" id="task-id" placeholder="Price">
                                                            </div>
                                                        ...
                                                        <input type="text" class="form-control" id="startDate" placeholder="Choose date and time">
                                                            ...
                                                            <div class="xl:col-span-6 col-span-12">
                                                                ...
                                                                <select class="form-control" data-trigger id="choices-single-default1">
                                                                    ...
                                                                    <option value="Medium">Food</option>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table whitespace-nowrap table-bordered min-w-full">
                                                ...
                                                <tr>
                                                        ...
                                                        <th scope="col" class="text-start">Wallet</th>
                                                        <th scope="col" class="text-start">Category</th>
                                                        <th scope="col" class="text-start">Created_at</th>
                                                ...
                                                <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                ...
                                                                <div class="font-semibold">Labtop</div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <span>50000EGP</span>
                                                        ...
                                                        <td>
                                                            <span class="badge   text-white">12/2/2024</span>
                                                        </td>


                                                        <td>
                                                            <span class="badge bg-warning/10 text-warning">Done</span>
                                                        </td>
                                                        <td>
                                                        <div class="flex items-center">
                                                <div class="progress progress-xs  course-status-progress progress-animate me-2" >
                                                    <div class="progress-bar progress-bar-striped !bg-warning w-[99%]"></div>
                                                </div>
                                                <div>70%</div>
                                            </div>
                                                        </td>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <span class="badge bg-primary/10 text-primary">InProgress</span>
                                                        </td>
                                                        <td>
                                                        <div class="flex items-center">
                                                <div class="progress progress-xs  course-status-progress progress-animate me-2" >
                                                    <div class="progress-bar progress-bar-striped !bg-primary w-[70%]"></div>
                                                </div>
                                                <div>70%</div>
                                            </div>
                                                        </td>
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-body !p-0">
                                            <div class="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">Inprogress Goals
                                            ...
                                            <div class="p-4 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">GOALS COUNT
                                            ...
                                            <div class="flex items-start p-4 border-b dark:border-defaultborder/10 border-dashed flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">Done Goals
