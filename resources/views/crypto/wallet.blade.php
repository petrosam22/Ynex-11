                                                ...
                                                <div class="flex items-center gap-2">
                                                    <div class="leading-none">
                                                        <span class="avatar avatar-rounded">
                                                            <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/square-color/Bitcoin.svg" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                        ...
                                        <div class="xl:col-span-12 col-span-12">
                                            <div class="box custom-box">
                                                <div class="box-header justify-between">
                                                    ...
                                                    <div>
                                                        <button type="button" class="ti-btn ti-btn-outline-primary ti-btn-wave">Connect</button>
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="flex items-center flex-wrap justify-between gap-4 mb-3">
                                                      <div class="flex-grow">
                                                          ...
                                                          <div class="input-group">
                                                                ...
                                                                <button type="button" class="ti-btn ti-btn-primary-full !mb-0">Copy</button>
                                                            </div>
                                                      </div>
                                                      <div>
