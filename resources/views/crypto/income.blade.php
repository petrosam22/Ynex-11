            ...
            <div class="content">
                <div class="main-content">
                        ...
                        <div class="block justify-between page-header md:flex">
                            <div>
                                <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Income
</h3>
                            </div>
                                ...
                                <div class="box">
                                    <div class="box-header justify-between">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <div>
                                                <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-secondary-full !py-1 !px-2 !text-[0.75rem] btn-wave" data-hs-overlay="#create-task">Create Income</button>
                                            </div>
                                        </div>
                                                ...
                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                                  <div class="ti-modal-content">
                                                    <div class="ti-modal-header">
                                                        <h6 class="modal-title" id="staticBackdropLabel2">Add Income
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-body !p-0">
                                            <div class="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">New Income
                                            ...
                                            <div class="p-4 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">Total Income 
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                                                            <span class="text-success me-1 font-semibold">
                                                                <i class="ri-arrow-up-s-line me-1 align-middle"></i>1.16%
                                                            </span>
                                                            <span>this month</span>
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="flex items-start p-4 border-b dark:border-defaultborder/10 border-dashed flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <div>
                                                    <h4 class="text-[1.125rem] font-semibold mb-2"><span class="count-up" >
                                                        1000</span>
                                                        <span class="text-[#8c9097] dark:text-white/50 ltr:float-right rtl:float-left text-[.6875rem] font-normal">
                                                            Last Year</span></h4>
                                                        <p class="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
                                                            <span class="text-success me-1 font-semibold">
                                                                <i class="ri-arrow-up-s-line me-1 align-middle"></i>1.16%
