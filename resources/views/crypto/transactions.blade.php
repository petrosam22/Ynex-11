            ...
            <div class="content">
                <div class="main-content">
                        ...
                        <div class="block justify-between page-header md:flex">
                            <div>
                                <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Transactions
</h3>
                            </div>
                                ...
                                <div class="box">
                                    <div class="box-header justify-between">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <div>
                                                <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-secondary-full !py-1 !px-2 !text-[0.75rem] btn-wave" data-hs-overlay="#create-task">Create Transaction</button>
                                            </div>
                                        </div>
                                                ...
                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                                  <div class="ti-modal-content">
                                                    <div class="ti-modal-header">
                                                        <h6 class="modal-title" id="staticBackdropLabel2">Add Transactions
                                            ...
                                            <table class="table whitespace-nowrap table-bordered min-w-full">
                                                ...
                                                <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/Bitcoin.svg" alt="">
                                                                </span>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/Dash.svg" alt="">
                                                                </span>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/Euro.svg" alt="">
                                                                </span>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/Ethereum.svg" alt="">
                                                                </span>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/Golem.svg" alt="">
                                                                </span>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/litecoin.svg" alt="">
                                                                </span>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/Ripple.svg" alt="">
                                                                </span>
                                                    ...
                                                    <tr class="border border-defaultborder transaction">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center gap-2">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="https://php.spruko.com/tailwind/ynex/ynex/assets/images/crypto-currencies/regular/monero.svg" alt="">
                                                                </span>
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-body !p-0">
                                            ...
                                            <div class="p-4 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">Expenses Transactions
                                            ...
                                            <div class="flex items-start p-4 border-b dark:border-defaultborder/10 border-dashed flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    <h6 class="mb-2 text-[0.75rem]">InCome Transactions
