                ...
                <div class="main-content">
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-header justify-between">
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                <a href="javascript:void(0);" class="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#todo-compose"><i class="ri-add-line font-semibold align-middle"></i>Add Company
                                                </a>
                                                ...
                                                <table class="table whitespace-nowrap min-w-full">
                                                    <thead>
                                                        ...
                                                        <th scope="col" class="text-start">Company Name</th>
                                                            ...
                                                            <th scope="col" class="text-start">Position</th>
                                                             <th scope="col" class="text-start">Expected Salary</th>
                                                    ...
                                                    <tbody>
                                                        <tr class="border border-x-0 border-defaultborder crm-contact">
                                                            ...
                                                            <td>
                                                                <div class="btn-list">
                                                                    <button aria-label="button" type="button" class="ti-btn ti-btn-sm ti-btn-warning" data-hs-overlay="#hs-overlay-contacts"><i class="ri-eye-line"></i></button>
                                                                    <button aria-label="button" type="button" class="ti-btn ti-btn-sm ti-btn-info"><i class="ri-pencil-line"></i></button>
                                                                    <button aria-label="button" type="button" class="ti-btn ti-btn-sm ti-btn-danger contact-delete"><i class="ri-delete-bin-line"></i></button>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr class="border border-x-0 border-defaultborder crm-contact">
                                                        ...
                                                        <tr class="border border-x-0 border-defaultborder crm-contact">
                                                            ...
                                                            <td>
                                                                <div class="flex items-center flex-wrap gap-1">
                                                                    <span class="badge bg-pink/10 text-pink">Large Enterprise</span>
                                                                </div>
                                                            </td>
                            ...
                            <div class="hs-overlay hidden ti-offcanvas ti-offcanvas-right !max-w-[25rem] !border-0" tabindex="-1" id="hs-overlay-contacts">
                                <div class="ti-offcanvas-body !p-0">
                                    ...
                                    <div class="p-6 border-b border-dashed border-defaultborder flex items-center gap-3">
                                ...
                                <div class="ti-modal-content">
                                    ...
                                    <div class="ti-modal-body px-4">
                                        <div class="grid grid-cols-12 gap-4">
                                            ...
                                            <div class="xl:col-span-6 col-span-12">
                                                <label for="company-lead-score" class="form-label">Position</label>
                                                <input type="number" class="form-control" id="company-lead-score" placeholder="Position">
                                            </div>
                                            <div class="xl:col-span-12 col-span-12">
                                            ...
                                            <div class="xl:col-span-12 col-span-12">
                                                <label for="key-contact" class="form-label">Expected Salary	</label>
                                                <input type="text" class="form-control" id="key-contact" placeholder="Contact Name">
                                            </div>
                                            <div class="xl:col-span-12 col-span-12">
                                                <label class="form-label">Industry</label>
                                                <input type="text" class="form-control" id="key-contact" placeholder="Industry Name">
                                    ...
                                    <div class="ti-modal-footer">
                                        ...
                                        <button type="button" class="ti-btn bg-primary text-white !font-medium">Create Company</button>
                                    </div>
                                </div>
                                </div>
                            </div>
