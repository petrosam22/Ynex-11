...
<div class="content">
    <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> workspaces Create </h3>
                </div>
                ...
                <div class="xl:col-span-12 col-span-12">
                    <div class="box custom-box">
                        ...
                        <div class="box-body">
                            <div class="grid grid-cols-12 gap-4">
                                <div class="xl:col-span-3 col-span-12">
                                    <label for="input-label" class="form-label">workspace Name :</label>
                                ...
                                <div class="xl:col-span-3 col-span-12">
                                    ...
                                    <option value="Choice 1" selected>Learning</option>
                                    <option value="Choice 2">Project</option>
                                    <option value="Choice 3">Dates</option>
                        ...
                        <div class="box-footer">
                            <button type="button" class="ti-btn ti-btn-primary btn-wave ms-auto float-right">Create Workspace</button>
                        </div>
                    </div>
                </div>
            </div>
