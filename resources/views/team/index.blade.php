...
<div class="content">
    <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Teams List</h3>
                </div>
                        ...
                        <div class="box-body p-4">
                            <div class="flex items-center justify-between flex-wrap gap-4">
                                <div class="flex flex-wrap gap-1 newproject">
                                    <a href="projects-create.html" class="ti-btn ti-btn-primary-full me-2 !mb-0"><i class="ri-add-line me-1 font-semibold align-middle"></i>New Teams</a>
                                ...
                                <div class="flex" role="search">
                                    <input class="form-control me-2" type="search" placeholder="Search Team" aria-label="Search">
                ...
                <div class="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div class="box custom-box">
                        <div class="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div class="flex-grow">
                                <a href="javascript:void(0);" class="font-semibold text-[.875rem] block text-truncate project-list-title">Ui</a>
                                <span class="text-[#8c9097] dark:text-white/50 block text-[0.75rem]">Total <strong class="text-defaulttextcolor">18/22</strong> Project completed</span>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <div class="text-end">
                                    ...
                                    <span class="badge bg-success/10 text-success">220</span>
                                </div>
                            </div>
                        ...
                        <div class="box-footer flex items-center justify-between">
                            <div>
                                <span class="text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">Created At :</span>
                ...
                <div class="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div class="box custom-box">
                        ...
                        <div class="box-body">
                            <div class="flex items-center justify-between mb-3">
                                <div>
                                    <div class="font-semibold mb-1">Member :</div>
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/12.jpg" alt="img">
                                        </span>
                                ...
                                <div class="text-end">
                                    ...
                                    <span class="badge bg-info/10 text-info">220</span>
                                </div>
                            </div>
                            <div class="font-semibold mb-1">Description :</div>
                            <p class="text-[#8c9097] dark:text-white/50 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi maiores similique tempore.</p>
