...
<div class="content">
    <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold">  Overview</h3>
                </div>
                ...
                <div class="xl:col-span-9 col-span-12">
                    <div class="box custom-box">
                        <div class="box-header justify-between flex">
                            ...
                            <div>
                                <a href="projects-create.html" class="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-secondary btn-wave"><i class="ri-add-line align-middle me-1 font-semibold"></i>Create Course</a>
                            </div>
                        </div>
                        <div class="box-body">
                            <h5 class="font-semibold mb-4 task-title">
                                Php For Biggner To Hero Course.
                            </h5>
                            <div class="text-[.9375rem] font-semibold mb-2">Courses Description :</div>
                            ...
                            <div class="text-[.9375rem] font-semibold mb-2">Lessons :</div>
                            <div class="mb-3">
                        ...
                        <div class="box-footer">
                            <div class="flex items-center justify-between gap-2 flex-wrap">
                                <div>
                                    <span class="block text-[#8c9097] dark:text-white/50 text-[0.75rem]">Instructor</span>
                                ...
                                <div>
                                    <span class="block text-[#8c9097] dark:text-white/50 text-[0.75rem]">Duration </span>
                                    <span class="block"><span class="badge bg-primary/10 text-primary">30H</span></span>
                                </div>
                                <div>
                                ...
                                <div>
                                    <span class="block text-[#8c9097] dark:text-white/50 text-[0.75rem]">Category </span>
                                    <span class="block text-[.875rem] font-semibold"><span class="badge bg-success/10 text-success">Development</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="xl:col-span-3 col-span-12">
                    <div class="box custom-box">
                        <div class="box-header justify-between">
                            ...
                            <div>
                                <button type="button" class="ti-btn ti-btn-light !py-1 !px-2 !text-[0.75rem]">
                                    <i class="ri-add-line align-middle me-1 font-semibold"></i>
                                        ...
                                        <tr class="border-y border-defaultborder">
                                            <td>
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="font-semibold">  Write Your First  	
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="border-y border-defaultborder">
                                            <td>
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="font-semibold">Variables in PHP</div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="border-y border-defaultborder">
                                            <td>
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="font-semibold">Perform Operations Variables	
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="border-defaultborder">
                                            <td>
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="font-semibold">Basic Variable Types 	
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                    ...
                    <div class="box custom-box">
                        <div class="box-header justify-between">
                            <div class="box-title">Course Goals</div>
