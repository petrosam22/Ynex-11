...
<div class="content">
    <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Courses List</h3>
                </div>
                        ...
                        <div class="box-body p-4">
                            <div class="flex items-center justify-between flex-wrap gap-4">
                                <div class="flex flex-wrap gap-1 newproject">
                                    <a href="projects-create.html" class="ti-btn ti-btn-primary-full me-2 !mb-0"><i class="ri-add-line me-1 font-semibold align-middle"></i>New Course</a>
                ...
                <div class="xxl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12">
                    <div class="box custom-box">
                        <div class="box-header items-center !justify-start flex-wrap !flex">
                            ...
                            <div class="flex-grow">
                                <a href="javascript:void(0);" class="font-semibold text-[.875rem] block text-truncate project-list-title">PHP For Biggner To Hero</a>
                                <span class="text-[#8c9097] dark:text-white/50 block text-[0.75rem]">Total <strong class="text-defaulttextcolor">10/22</strong> lessons completed</span>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <div class="text-end">
                                    ...
                                    <span class="badge bg-success/10 text-success">Full Time	</span>
                                </div>
                            </div>
                        ...
                        <div class="box-footer flex items-center justify-between">
                            <div>
                                <span class="text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">Started Date :</span>
                                <span class="font-semibold block">24,May 2023</span>
                            </div>
                            <div class="text-end">
                                <span class="text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">Ended Date :</span>
